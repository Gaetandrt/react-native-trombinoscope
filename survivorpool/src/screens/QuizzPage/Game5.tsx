...
const NextPage = "Game6";
const Question = "Quel est le poste de Ava Green ?";
const Answer1 = "HR Coordinator";
const Answer2 = "Projet Manager";
const Answer3 = "HR Manager";
const Answer4 = "Administrative Assistant";
