...
const NextPage = "Game4";
const Question = "Quel est le poste de Henry Turner ?";
const Answer1 = "Administrative Assistant";
const Answer2 = "Sales Representative";
const Answer3 = "Administrative Intern";
const Answer4 = "Account Manager";
    ...
    const incrementScore = async () => {
        try {
          ...
          if (currentScore !== null) {
            ...
            console.log('AsyncStorage :', newScore);
      ...
      const handleButtonPress2 = () => {
          setButtonColor2('green'); // Change la couleur du bouton en vert
      ...
      const handleButtonPress3 = () => {
          setButtonColor3('red'); // Change la couleur du bouton en vert
