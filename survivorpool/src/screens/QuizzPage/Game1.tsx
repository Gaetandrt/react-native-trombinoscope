...
import { View, Text, StyleSheet, SafeAreaView, Image, TextInput, TouchableOpacity, ImageBackground, TouchableHighlight } from 'react-native';
...
const NextPage = "Game2";
const Question = "Combien y a t'il de Maketing specialist ?";
const Answer1 = "6";
const Answer2 = "10";
const Answer3 = "3";
const Answer4 = "5";
...
const Game: React.FC<{ navigation: any }> = ({ navigation }) => {
    ...
    const handleButtonPress = () => {
        setButtonColor('green'); // Change la couleur du bouton en vert
