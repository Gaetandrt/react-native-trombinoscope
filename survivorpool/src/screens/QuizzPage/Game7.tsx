...
const NextPage = "Game8";
const Question = "Quel est le poste de John Doe ?";
const Answer1 = "HR Coordinator";
const Answer2 = "CEO";
const Answer3 = "Administrative Assistant";
const Answer4 = "CMO";
...
const Game: React.FC<{ navigation: any }> = ({ navigation }) => {
    ...
    const incrementScore = async () => {
      ...
      const handleButtonPress4 = () => {
          setButtonColor4('green'); // Change la couleur du bouton en vert
