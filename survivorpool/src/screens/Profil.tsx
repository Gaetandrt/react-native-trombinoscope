...
const Profil: React.FC<{ navigation: any, route: any }> = ({ navigation, route }) => {
                    ...
                    {show === false && (
                        <View style={styles.close}>
                            <TouchableOpacity onPress={() => navigation.navigate("Trombie")}>
                                <MoodIcon name="chevron-left" size={30} color='white' />
                            </TouchableOpacity>
                        </View>
                    )}
                    <View style={[styles.content, { marginTop: (show) ? vh(45) : (vh(40) - 46), backgroundColor }]}>
